...
CONTENTS = [
    {
        ...
        "is_new": True,
        "table_of_contents": [
            {"id": "intro", "title": "Bash란?", "emoji": "🐚", "level": 1, "timestamp": 0},
            {"id": "syntax", "title": "기본 문법", "emoji": "📝", "level": 1, "timestamp": 30},
            {"id": "scripts", "title": "스크립트 작성", "emoji": "📜", "level": 1, "timestamp": 60},
            {"id": "advanced", "title": "고급 기능", "emoji": "⚡", "level": 1, "timestamp": 90}
        ],
...
크론잡으로 스크립트를 주기적으로 실행하거나, CI/CD 파이프라인에서 bash 스크립트를 활용해 빌드와 배포를 자동화할 수 있습니다.""",
    ...
    },
    {
        ...
        "is_new": False,
        "table_of_contents": [
            {"id": "intro", "title": "Go 언어 소개", "emoji": "🔷", "level": 1, "timestamp": 0},
            {"id": "syntax", "title": "기본 문법과 타입", "emoji": "📐", "level": 1, "timestamp": 25},
            {"id": "concurrency", "title": "고루틴과 동시성", "emoji": "⚙️", "level": 1, "timestamp": 60},
            {"id": "compile", "title": "컴파일과 실행", "emoji": "🚀", "level": 1, "timestamp": 110}
        ],
...
컴파일 속도가 매우 빠르고, 정적 링크로 단일 바이너리를 생성합니다. 내장된 포매터(gofmt)로 일관된 코드 스타일을 유지합니다.""",
    ...
    },
    {
        ...
        "is_new": False,
        "table_of_contents": [
            {"id": "intro", "title": "T3 Stack 소개", "emoji": "📚", "level": 1, "timestamp": 0},
            {"id": "setup", "title": "프로젝트 설정", "emoji": "⚙️", "level": 1, "timestamp": 180},
            {"id": "trpc", "title": "tRPC 라우터 구현", "emoji": "🔗", "level": 1, "timestamp": 600},
            {"id": "deploy", "title": "배포하기", "emoji": "🚀", "level": 1, "timestamp": 1200}
        ],
...
Vercel에 원클릭 배포가 가능합니다. 데이터베이스는 PlanetScale 또는 Supabase를 추천합니다.""",
    ...
    },
    {
        ...
        "is_new": False,
        "table_of_contents": [
            {"id": "intro", "title": "업데이트 개요", "emoji": "📋", "level": 1, "timestamp": 0},
            {"id": "newfeat", "title": "주요 신규 기능", "emoji": "✨", "level": 1, "timestamp": 300},
            {"id": "breaking", "title": "변경사항과 마이그레이션", "emoji": "⚠️", "level": 1, "timestamp": 900},
            {"id": "verdict", "title": "개발자 관점 평가", "emoji": "🎯", "level": 1, "timestamp": 1500}
        ],
...
기존 프로젝트를 업데이트할 때는 `strict` 모드를 활성화하고, 새로운 기능을 점진적으로 도입하는 것이 좋습니다. 대부분의 변경사항은 하위 호환성을 유지합니다.""",
    ...
    },
    {
        ...
        "is_new": False,
        "table_of_contents": [
            {"id": "why", "title": "왜 Neovim인가?", "emoji": "🤔", "level": 1, "timestamp": 0},
            {"id": "install", "title": "설치 및 기본 설정", "emoji": "💻", "level": 1, "timestamp": 120},
            {"id": "plugins", "title": "플러그인 설정", "emoji": "🔌", "level": 1, "timestamp": 480},
            {"id": "lsp", "title": "LSP와 자동 완성", "emoji": "🧠", "level": 1, "timestamp": 900},
            {"id": "tips", "title": "실전 팁", "emoji": "💡", "level": 1, "timestamp": 1500}
        ],
...
단축키를 외우는 것보다 필요한 순간에 찾아서 쓰는 것이 더 효과적입니다. 점진적으로 학습하는 것이 지속 가능한 방법입니다.""",
    ...
    },
    {
        ...
        "is_new": True,
        "table_of_contents": [
            {"id": "basics", "title": "Vim 기본 개념", "emoji": "📖", "level": 1, "timestamp": 0},
            {"id": "motions", "title": "모션과 단축키", "emoji": "🧭", "level": 1, "timestamp": 150},
            {"id": "modes", "title": "모드 이해하기", "emoji": "🔄", "level": 1, "timestamp": 360},
            {"id": "practice", "title": "실전 연습", "emoji": "⚡", "level": 1, "timestamp": 540}
        ],
